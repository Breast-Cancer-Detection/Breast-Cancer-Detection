...
const teamMembers = [
  {
    ...
    bio: 'Cleaned Data. Upgraded the 4-model CNN ensemble. Upgraded to Grad-CAM++. Integrated models into FastAPI backend. Updated React UI. Integrated Supabase authentication. Uploaded frontend on Vercel and backend on Railway. Designed architecture for project',
  },
  {
    name: 'Cephas',
